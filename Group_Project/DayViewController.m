...
- (void) viewWillAppear:(BOOL)animated{
    ...
    if (![PFUser currentUser]) {
        UIAlertView *alert = [[UIAlertView alloc]initWithTitle:@"once you join a group" message:@"you can view when everyone is in class" delegate:nil cancelButtonTitle:@"okay" otherButtonTitles:nil, nil];
        [alert show];
    }
